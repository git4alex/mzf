...
public class ProductInventoryService {
    ...
    public int warehouse(BizType bizType, int productId, int targetOrgId, StorageType storageType, int sourceOrgId, String remark, IUser user) throws BusinessException {
        ...
        List<Map<String, Object>> inventorys = list(new Integer[]{productId}, null);
...
//                storageType, TargetType.product, Integer.toString(productId), null, remark, user);
    ...
    public Map<String, Object> getInventoryByNumOnSale(String productNum, IUser user) throws BusinessException {
    ...
    public Map<String, Object> getInventoryByNum(String productNum, int orgId) throws BusinessException {
        Map<String, Object> where = new HashMap<String, Object>();
        where.put("num", productNum);
        where.put("inventoryStatus", InventoryStatus.onStorage);
...
//		deliveryByProductId(BizType.receive, productId, remark, InventoryStatus.onPassage, false, user);
    ...
    public List<Map<String, Object>> list(Integer[] productIds, Integer orgId) throws BusinessException {
    ...
    public List<Map<String, Object>> listByNum(String[] nums, Integer orgId) throws BusinessException {
        EntityMetadata metadata = metadataProvider.getEntityMetadata(MzfEntity.PRODUCT_INVENTORY_VIEW);
        Map<String, Object> where = new HashMap<String, Object>();
    ...
    public Map<String, Object> getInventory(int productId, Integer orgId) throws BusinessException {
        List<Map<String, Object>> list = list(new Integer[]{productId}, orgId);
        if (CollectionUtils.isEmpty(list)) {
