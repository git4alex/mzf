...
public class ProductDemandProcessContoller {
	...
	public Map getDemandProcess(@PathVariable final int demandId, HttpServletRequest request) {
		OperateTemplete templete = new HttpTemplete(request) {
			protected void doSomething() throws BusinessException {				
				Map<String, Object> demandProcess = productDemandProcessService.getDemandProcess(demandId, this.getUser());
	...
	@ResponseBody
	public Map reject(@RequestBody final Integer[] demandIds, HttpServletRequest request) {
		OperateTemplete templete = new HttpTemplete(request) {
			protected void doSomething() throws BusinessException {				
	...
	public Map cancel(@PathVariable final int demandId, HttpServletRequest request) {
		OperateTemplete templete = new HttpTemplete(request) {
			protected void doSomething() throws BusinessException {				
				productDemandProcessService.cancelDemand(demandId, this.getUser());
			}			
		};
